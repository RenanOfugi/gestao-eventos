...
public record FormularioComumCreateRequestDto(
        @NotNull(message = "Campo nome obrigatório do formulário comum")
        String nome,

        @NotNull(message = "campo cpfCnpj obrigatório do formulário comum")
        String cpfCnpj,
        ...
        List<CampoEspecificoCreateRequestDto> camposEspecificos
){
}
